...
import { DashboardOutlined, DesktopOutlined, PieChartOutlined, UserOutlined } from '@ant-design/icons';
...
const items: MenuProps['items'] = [
  ...
  getItem(<Link to={'/restaurant'}>Restaurant</Link>, 'restaurant', <PieChartOutlined />),
